...
public class LevelReader {
    ...
    public LevelReader(int num) {
        ...
        try {
            this.f = new FileReader(getLevelFile(num));
        ...
        while (scanner.hasNextLine()) {
            ...
            for (int i = 0; i < line.length(); i++) {
                ...
                this.ch[count][i] = c;
                int pos_x = i*96, pos_y= count*108;
                if (c == '1') {
                    this.on = 1;
                }
                if (c == '2') {
                ...
                if (c == '_') {
                    Platform p = new Platform(pos_x,pos_y, 100, 40);
                ...
                if (c == '-') {
                    Platform p = new Platform(pos_x,pos_y, 100, 70);
                    platforms.add(p);
                }
                if (c == 'R') {
